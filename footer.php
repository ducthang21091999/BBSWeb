...
<div class="footer-inner">
  ...
  <nav class="footer-nav">
    <?php
    // Editable in Appearance → Menus (location: Footer Navigation).
    if ( has_nav_menu('footer') ) {
        ...
        $footer_links = [
            [ 'url' => get_post_type_archive_link('film'), 'label' => bbs_t('Movies') ],
        ];
        ...
        foreach ( $footer_links as $l ) {
            printf('<li><a href="%s">%s</a></li>', esc_url($l['url']), esc_html($l['label']));
        }
        echo '</ul>';
    }
    ?>
